                    ...
                    {group.map((card, cardIndex) => (
                        <Card key={cardIndex} tag={"article"}>
                            ...
                            <CardBody>
                                ...
                                <CardLink href={`/details/${cardIndex}`} aria-label={card.title}>En savoir plus</CardLink>
                                <CardLink href={`/details/${cardIndex}#comments`} aria-label={"Commentaires de "+card.title}>Voir les commentaires</CardLink>
                            </CardBody>
                        </Card>
                    ))}
                </CardGroup>
